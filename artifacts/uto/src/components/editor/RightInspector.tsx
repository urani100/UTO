      ...
      <InspectorSection title="Text">
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            rows={5}
            className="field-bordered text-[12px] font-serif leading-relaxed resize-y bg-background/80 border-0 shadow-none"
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="field-bordered flex-1 text-[11px] num-tab font-mono bg-foreground/[.03] px-2 py-1 focus:outline-none"
            />
          </div>
        </div>
